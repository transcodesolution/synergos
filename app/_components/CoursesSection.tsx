...
export const CoursesSection = async () => {
    ...
    return < Box className="section_Divider" bg='theme-orange.0' >
        <Container size="xl" >
            <Title c='theme-black.2' fw={400} order={3} lh={{ base: rem(20), md: rem(50) }} mb={20} >
            ...
            <Grid gutter={{ base: "xl", md: "lg", lg: "36" }} >
                {posts.splice(0, 3).map((course, index) => (
                    <GridCol span={{ base: 12, md: 6, lg: 4 }} key={index} >
                        <Title c="theme-black.2" mb='sm' order={3} lineClamp={2} mih={rem(84)}>{course.title}</Title>
                        <Text c="theme-black.2" mb='sm' size="16px" lineClamp={2} mih={rem(32)}>{course.title}</Text>
                        ...
                        <br />
                        <Text c="theme-black.2" lineClamp={3} lh={{ base: rem(20), md: rem(24) }} mih={rem(72)}>{course.body}</Text>
                        <br />
